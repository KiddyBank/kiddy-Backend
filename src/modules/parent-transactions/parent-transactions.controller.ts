...
export class ParentTransactionsController {
  constructor(
    private readonly parentTransactionsService: ParentTransactionsService,
  ) {}
  ...
  update(
    @Param('id') id: string,
    @Body() updateParentTransactionDto: UpdateParentTransactionDto,
  ) {
    return this.parentTransactionsService.update(
      +id,
      updateParentTransactionDto,
    );
  }
